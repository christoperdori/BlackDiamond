    ...
    <table class="table table-striped bg-white mt-2">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center">PB5053</td>
                <td>English for International Comunication</td>
                <td></td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">1</td>
            ...
            <tr>
                ...
                <td style="text-align: center">SP5423</td>
                <td>Investasi dan Pasar Modal</td>
                <td></td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">1</td>
            ...
            <tr>
                ...
                <td style="text-align: center">SP5313 </td>
                <td>Manajemen Konten Web</td>
                <td></td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">1</td>
