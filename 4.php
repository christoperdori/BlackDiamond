    ...
    <table class="table table-striped bg-white mt-2">
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center">SI2443</td>
                <td>Bahasa Inggris Terapan</td>
                <td></td>
            ...
            <tr>
                ...
                <td style="text-align: center">SI3433</td>
            ...
            <tr>
                ...
                <td style="text-align: center">SI2423</td>
                <td>Manajemen & Tata Kelola Teknologi Informasi</td>
                <td></td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">2</td>
            ...
            <tr>
                ...
                <td style="text-align: center">SI2463</td>
                ...
                <td></td>
                <td style="text-align: center"><button class="btn btn-success">LIHAT</button></td>
                <td style="text-align: center"><a class="btn btn-primary" href="grup.php">PILIH</a></td>
            </tr>
            <tr>
                <th scope="row" style="text-align: center">5</th>
                <td style="text-align: center">SK2413</td>
                <td>Pengantar Sistem Layanan Kesehatan</td>
                <td></td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">1</td>
                <td><img src="IKONS/PNG/32/warning.png" alt="" height="15"> Tabrakan dengan matakuliah<br> Interaksi Manusia dan Komputer<br> Rabu 11.30-13.20</td>
                <td style="text-align: center"><button class="btn btn-success">LIHAT</button></td>
                <td style="text-align: center"><a class="btn btn-primary" href="#" onfocus="warna(this)" onclick="alert('Warning : Tabrakan dengan matakuliah Interaksi Manusia dan Komputer Grup B')" >PILIH</a></td>
            </tr>
        </tbody>
    </table>
</body>
