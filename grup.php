...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a href="4.php" class="btn btn-outline-dark"><strong><b><h4><</h4></b></strong></a>
    <table class="table table-striped bg-white mt-2">
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center">SI2443<br>PR2463</td>
                <td>Teori Pemrograman Berbasis Web<br>Praktikum</td>
                <td style="text-align: center">A</td>
                <td style="text-align: center">Rabu &nbsp&nbsp&nbsp 09.30-11.20 &nbsp LAB B<br>Kamis &nbsp&nbsp 13.30-15.20 &nbsp LAB B</td>
                <td style="text-align: center">15</td>
                <td>Katon Wijana, S.Kom., M.T<br>Eko Verianto, S.Kom., M.Cs. </td>
            ...
            <tr>
                ...
                <td style="text-align: center">Senin &nbsp&nbsp 09.30-11.20 &nbsp LAB B<br>Kamis &nbsp&nbsp 15.30-17.20 &nbsp LAB B</td>
                <td style="text-align: center">20</td>
                <td>Katon Wijana, S.Kom., M.T<br>Eko Verianto, S.Kom., M.Cs. </td>
                <td style="text-align: center"><a href="regis.php" class="btn btn-primary">PILIH</a></td>
            </tr>
        </tbody>
    </table>
</body>
