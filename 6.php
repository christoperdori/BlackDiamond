    ...
    <table class="table table-striped bg-white mt-2">
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center">MH1033</td>
            ...
            <tr>
                ...
                <td style="text-align: center">SI3413</td>
                <td>Kewirausahaan Berbasis Teknologi Informasi</td>
                <td></td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">2</td>
            ...
            <tr>
                ...
                <td style="text-align: center">SI3443</td>
                <td>Kuliah Kerja Nyata/Service Learning</td>
                <td></td>
                <td style="text-align: center">3</td>
                <td style="text-align: center">3</td>
            ...
            <tr>
                ...
                <td style="text-align: center">SI2413</td>
            ...
            <tr>
                ...
                <td style="text-align: center">SE4313</td>
